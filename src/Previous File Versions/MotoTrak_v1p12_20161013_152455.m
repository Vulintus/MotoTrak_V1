function MotoTrak_v1p12

%Compiled: 10/13/2016, 15:24:55

MotoTrak_Startup;                                                          %Call the startup function.


function MotoTrak_Startup(varargin)
...
if isa(msg,'MException')                                                    %If the message to send is an error exception...
    txt = getReport(msg,'extended');                                        %Get an exteded report about the error.
    ...
    elseif ischar(txt)                                                      %Otherwise, if the message text is already a string...
...
try                                                                         %Attempt to send an email with the error information.
    ...
    props.setProperty('mail.smtp.socketFactory.class', ...
                      'javax.net.ssl.SSLSocketFactory');                    %Create an SSL socket.
