function MotoTrak_v1p15

%Compiled: 01/09/2018, 14:30:27
    ...
    while max(mon_signal) < h.init && ...
        ...
        if a > 0                                                            %If there was any new data in the stream.
            ...
            try                                                             %Attempt to add new samples to the buffer.
                ...
                txt = MotoTrak_Save_Error_Report(h,txt);                    %Save a copy of the error in the AppData folder.
...
if isfield(h,'variant') && strcmpi(h.variant,'isaac cassar')                %If this is Isaac Cassar's variant...
    ...
    txt = MotoTrak_Save_Error_Report(h,str);                                %Save a copy of the error in the AppData folder.
    MotoTrak_Send_Error_Report(h,h.err_rcpt,txt);                           %Send the string as error report to the specified recipient.
end
