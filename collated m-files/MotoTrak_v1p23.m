function MotoTrak_v1p23

%Compiled: 03/02/2020, 15:42:33
...
if ~isfield(handles,'ardy')                                                 %If the Arduino isn't already connected in a pre-existing handles structure...
    ...
    if ~isempty(handles.ardy) && handles.ardy.version < 221                 %If the Arduino sketch version is older than version 2.2...
